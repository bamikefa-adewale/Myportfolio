...
const Contact = () => {
  return (
    ...
    //       <h1 className="font-extrabold text-[60px] text-transparent bg-gradient-to-r from-pink-700 to-purple-300 bg-clip-text">
    //         Let's talk
    //       </h1>
    //       <p className="text-[#d8d8d8] text-xl leading-9 max-w-md">
    //         I'm cuurently available to take on new project, so feel free to send
    ...
    //       <label className="text-[#d8d8d8] text-xl font-medium" htmlFor="name">
    //         Your Name
    //       </label>
    //       <input
    //         className="border-none w-[600px] h-[60px] font-outfit rounded pl-4 bg-[#32323c] text-[#a0a0a0] text-xl"
    //         type="text"
    //         placeholder="Enter your name"
    //       />

    //       <label className="text-[#d8d8d8] text-xl font-medium" htmlFor="email">
    //         Your Email
    //       </label>
    //       <input
    //         className="border-none w-[600px] h-[60px] font-outfit rounded pl-4 bg-[#32323c] text-[#a0a0a0] text-xl"
    ...
    //       </label>
    //       <textarea
    //         className="w-[600px]  border-none pl-4 font-outfit rounded bg-[#32323c] text-[#a0a0a0] text-xl"
    //         name=" messagae"
